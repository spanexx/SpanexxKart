...
@Component({
  ...
  imports: [CommonModule, ProductComponent, FilterComponent, 
    SetHighlightsDirective, ProductDetailComponent, AppHoverDirective ],
...
export class ProductListComponent {
  ...
  products: Product[]  = [
    ...
    },
    {
      ...
      isInInventory: true,
      itemsLeft: 10,
      imageUrl: 'https://th.bing.com/th/id/R.766ac4cd89e65232b8667b7fb8c3f005?rik=L06IihjHDue3aw&pid=ImgRaw&r=0',
    },
    
    {
      ...
      isInInventory: true,
      itemsLeft: 6,
      imageUrl: 'https://th.bing.com/th/id/R.135c729c378df1e168029fb1603eec86?rik=Z7WNK79CrvB8vg&pid=ImgRaw&r=0',
      discount: true
    },

    {
      ...
      isInInventory: true,
      itemsLeft: 7,
      imageUrl: 'https://th.bing.com/th/id/OIP.0NyeHRpwALhinNsNF3DfXwHaEG?rs=1&pid=ImgDetMain',
    },
    {
      id: 7,
    ...
    },
    {
      ...
      isInInventory: true,
      itemsLeft: 12,
      imageUrl: 'https://th.bing.com/th/id/R.3b72462b0b952cb29f3aeee70ff7fe4c?rik=oM4VKmR%2bxzt72A&pid=ImgRaw&r=0',
      discount: true
    },
    {
      id: 11,
      ...
      isInInventory: false,
      itemsLeft: 15,
      imageUrl: 'https://th.bing.com/th/id/OIP.zmkFGcu9ywl9sGX_T3W5DgHaFB?w=2034&h=1380&rs=1&pid=ImgDetMain',
    },
    {
      id: 12,
    ...
    },
    {
      ...
      isInInventory: true,
      itemsLeft: 10,
      imageUrl: 'https://th.bing.com/th/id/R.8f4a4443971ca913a8a67185bfb72c96?rik=zuDlSmHZryAkMw&pid=ImgRaw&r=07',
      discount: true
    },
    {
      id: 14,
    ...
    },
    {
      ...
      isInInventory: false,
      itemsLeft: 15,
      imageUrl: 'https://th.bing.com/th/id/R.55b60c5c78add6d722047f2c722ccb4e?rik=UTBGn5YjYUZzIw&pid=ImgRaw&r=0',
      discount: true
    },
      {
        id: 16,
      ...
      },
      {
        ...
        isInInventory: true,
        itemsLeft: 7,
        imageUrl: 'https://th.bing.com/th/id/OIP.C6qzxjDAyn07f-iYZUSdPwHaHa?w=2000&h=2000&rs=1&pid=ImgDetMain',
      },
      {
        id: 19,
      ...
      },
      {
        ...
        isInInventory: true,
        itemsLeft: 6,
        imageUrl: 'https://www.tennisnuts.com/images/product/full/F32293_F_beauty_B2C.jpg',
      },
      {
        id: 21,
...
},
{
  ...
  isHovered(colors: string[]): boolean {
    ...
    // For simplicity, we assume the product is hovered if it has colors
    return colors && colors.length > 0;
  }

  All = this.products.length;
  InStock = this.products.filter(p => p.isInInventory).length;
  outOfStock = this.products.filter(p => !p.isInInventory).length;
  ...
  salesCardClick: boolean = false

  onSalesCardclick(){
    this.salesCardClick = !this.salesCardClick;
  }
